...
export default function Introduction() {
    return (
        <div id="home" className="min-h-screen min-w-screen flex flex-col bg-black">
            <div className="flex flex-col items-center justify-center gap-10 lg:flex-row md:flex-row lg:p-32 py-10 px-5 md:p-10 h-[85vh]">
                <div className="lg:w-[50%] md:w-[50%] flex flex-col gap-5 text-left items-left lg:items-start md:items-start">
